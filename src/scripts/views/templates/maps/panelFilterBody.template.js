...
<button class="btn btn-success btn-sm" id="inventarisRumijaButton" onclick="onClickInventarisRumija()" data-properties="${properties.id_ruas_jalan}" type="button" data-bs-toggle="offcanvas"
data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">INVENTARIS RUMIJA</button>
`;
};
